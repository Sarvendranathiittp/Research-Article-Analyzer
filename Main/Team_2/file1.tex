...
\v\title{\vspace{0cm} \fontsize{10}{12}\selectfont \textbf{COLOMBIAN JOURNAL OF ADVANCED TECHNOLOGIES INDICATIONS FOR PAPER SUBMITTION} 
space{6mm} \textbf{REVISTA COLOMBIANA DE TECNOLOGÍAS DE AVANZADA INDICACIONES PARA LA PRESENTACIÓN DE ARTÍCULOS}\vspace{4mm}}
