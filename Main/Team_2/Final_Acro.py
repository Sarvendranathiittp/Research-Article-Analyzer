...
class AcronymProcessor:
    ...
    exclude_path = r'C:\Users\rashm\Research-Article-Analyzer\Main\Team_2\xl.py'
...
input_string = """Transmit antenna selection (TASs) aalo Teacher Assistant(TA) is a technique that achieves better performance than a single\n"
    ...
    "class of fading models with TED continuous cumulative  EDDs distribution functions, LWIIR achieves TASs the lowest\n"
    "average symbol error probability (SEPs) among all TAS rules for an underlay cognitive radio system\n" "TSA"
    "that employs binary power control HRD ANM APL and is subject to the interference-outage constraint(IOC)."""
...
if a == keys:
    ...
    diff = set(a) - set(keys)
    print("\nNot defined or standard abbrevations:")
    print(diff)
    print("=========================================")
